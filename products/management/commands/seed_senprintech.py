    ...
    def handle(self, *args, **options):
        ...
        products = [
            ...
            },
            {
                ...
                "name": "Roll-up",
                "slug": "roll-up",
                "description": "Supports salons, boutiques et événements.",
            ...
            },
            {
                ...
                "name": "Stickers",
                "slug": "stickers",
                "description": "Stickers branding, packaging et événements.",
            ...
            {
                "category": "papeterie",
                "name": "Enveloppes & Papier en-tête",
        ...
        option_specs = {
            ...
            "t-shirts-personnalises": [
                ...
                ("Texte personnalisé", "texte", "text", False, []),
            ],
            "mugs-personnalises": [
            ...
            "enveloppes-papier-entete": [
                ("Support", "support", "select", True, [("Papier en-tête", "papier-entete", 0), ("Enveloppes", "enveloppes", 2500), ("Pack complet", "pack-complet", 6000)]),
